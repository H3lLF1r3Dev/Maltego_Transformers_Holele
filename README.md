HOLEHE Local Transform para Maltego (macOS) — Guia de Instalação e Uso
...
Crie um grafo novo
Arraste uma entidade Email Address para o canvas
Defina o valor do e-mail (ex.: test@gmail.com)
Clique com o botão direito na entidade:
...
Licença
Utilize o LICENSE do repositório (ou defina uma licença no arquivo LICENSE).
